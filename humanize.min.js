...
Humanize.naturalDateTime=function(timestamp,format){if(Humanize.naturalDay(timestamp,format)==="t\u00e4n\u00e4\u00e4n")return Humanize.naturalDay(timestamp,format)+", "+Humanize.naturalTime(timestamp,format);else return Humanize.naturalDay(timestamp,format)+" "+Humanize.naturalTime(timestamp,format)};
